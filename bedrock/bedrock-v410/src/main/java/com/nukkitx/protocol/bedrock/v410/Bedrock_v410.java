package com.nukkitx.protocol.bedrock.v410;
...
import com.nukkitx.protocol.bedrock.v410.serializer.*;
import lombok.experimental.UtilityClass;

@UtilityClass
public class Bedrock_v410 {
    public static BedrockPacketCodec V410_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(410)
            ...
            .registerPacket(TextPacket.class, TextSerializer_v410.INSTANCE, 9)
            .registerPacket(SetTimePacket.class, SetTimeSerializer_v291.INSTANCE, 10)
            .registerPacket(StartGamePacket.class, StartGameSerializer_v410.INSTANCE, 11)
