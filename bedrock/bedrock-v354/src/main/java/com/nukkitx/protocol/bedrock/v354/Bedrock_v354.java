...
import com.nukkitx.protocol.bedrock.v340.serializer.VideoStreamConnectSerializer_v340;
import com.nukkitx.protocol.bedrock.v354.serializer.*;
import lombok.experimental.UtilityClass;

@UtilityClass
public class Bedrock_v354 {
    public static final BedrockPacketCodec V354_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(354)
            .minecraftVersion("1.11.0")
            .helper(BedrockPacketHelper_v354.INSTANCE)
